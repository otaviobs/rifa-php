...
var adm = $.tab({
	c:{a:'modelo',mt:'este Modelo',ma:'Novo Modelo',add:'admin/modelo/',fn:function(){
	...
	th:[
		//{t:2,n:'Imagem',w:104,o:'i',tt:'n',a:'upload/modelos/',c:'i',d:'default.jpg',l:2,dl:1},
		{n:'Título',w:250,o:'t',tt:'h1',l:1,a:'admin/modelo/',c:'id',tb:0},
		{n:'Cadastrado em',w:130,o:'dc',tt:'_dc'},
		//{t:1,n:'Adicionar Fotos',w:250,o:'t',bt:[{tt:1,m:'cp',a:'admin/modelo-foto/',i:'ifolder',t:'Adicionar Fotos'}]},
