...
.ui-sortable tr:nth-child(n+11){background:#ebe9e9 !important;opacity:0.5}
...
<?
foreach($FILTROS as $k=>$v)echo '<div class="cell"><select name="'.$v.'" class="form-control"></select></div>';
?>
					<!--<div class="cell itxt">
...
var adm = $.tab({
	c:{a:'<?=$pgAjax?>',mt:'',ma:'',add:'',fn:function(){
...
if($temImg){
?>
		{t:2,n:'Imagem',w:104,o:'',tt:'n',a:'upload/<?=$pasta?>/',c:'i',d:'default.jpg',l:2,dl:1},
<?
}
?>
