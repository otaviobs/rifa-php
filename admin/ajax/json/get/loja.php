...
if($s->adm()||$s->ven()||$s->ger()){
	...
	if($q)$w[] = "(
		l.nome like '$qel' or
		l.cnpj like '$qel' or
		l.cidade like '$qel' or
		l.estado like '$qel' or
		l.telefone like '$qel' or
		l.email like '$qel' or
		l.email = '$Q')";
	...
	$sql = "select l.*,l.id_loja as id from $sql $w group by l.id_loja".($_ord?" order by $_ord":'')." limit {$pgn->i},{$pgn->l}";
