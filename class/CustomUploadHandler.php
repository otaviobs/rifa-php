...
class CustomUploadHandler extends UploadHandler {
	...
	protected function get_scaled_image_file_paths($file_name, $version) {
        ...
        if (!empty($version)) {
			...
			if($version=='thumb')uploadFoto::updateFotos($id,$tipo_post,$file_name,'it',$file_path);
			if($version=='carrinho')uploadFoto::updateFotos($id,$tipo_post,$file_name,'itc',$file_path);
			if($version=='home')uploadFoto::updateFotos($id,$tipo_post,$file_name,'ith',$file_path);
			if($version=='interno')uploadFoto::updateFotos($id,$tipo_post,$file_name,'iti',$file_path);
			if($version=='miniatura')uploadFoto::updateFotos($id,$tipo_post,$file_name,'itm',$file_path);
			if($version=='relacionado')uploadFoto::updateFotos($id,$tipo_post,$file_name,'itr',$file_path);
			if($version=='ultimos')uploadFoto::updateFotos($id,$tipo_post,$file_name,'itu',$file_path);
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if ($uploaded_file && is_uploaded_file($uploaded_file)) {
                ...
                if ($append_file) {
					...
					uploadFoto::insertFotos($s->id,$tipo_post,$file->name,$file_path);
                }
            } else {
    ...
    protected function handle_image_file($file_path, $file) {
        ...
        uploadFoto::convertFotos($file_path);
        // Free memory:
